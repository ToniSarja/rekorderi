...
class Menu:
    ...
    def valikko(self):
        ...
        menu = pygame_menu.Menu('', 800, 600,theme=pygame_menu.themes.THEME_BLUE)
        menu.add.button('Exec', game.paluu, 'foo', align=pygame_menu.locals.ALIGN_LEFT)
        table = menu.add.table(table_id='my_table', font_size=20)
        table.default_cell_padding = 5
        table.default_row_background_color = 'white'
        table.add_row(['First item', 'Second item', 'Third item'], cell_font=pygame_menu.font.FONT_OPEN_SANS_BOLD)
        table.add_row(['A', 'B', 1])
